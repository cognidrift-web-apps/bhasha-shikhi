 ...
 *
 * Self-contained copy for the relay server (deploys separately to Railway).
 * Source of truth: src/lib/prompts/tutor.ts
 */

// Local type definitions — mirrors src/lib/constants.ts
type Language = "english" | "german" | "arabic" | "hindi";
type Mode =
  | "word_by_word"
  | "conversation"
  | "roleplay"
